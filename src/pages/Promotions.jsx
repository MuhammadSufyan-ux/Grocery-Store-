...
import { ShoppingCart, Star, Percent, Tag, Filter, Grid, List } from "lucide-react";
...
function Promotions() {
    ...
    const promotionProducts = [
        {
            id: 1,
            badge: { text: "30% OFF", color: "bg-[#3B745B]", textColor: "text-white" },
            category: "Vegetables",
            name: "Redish 500g",
            image: redish,
            rating: 4,
        ...
        {
            id: 2,
            badge: { text: "50% OFF", color: "bg-[#E74C3C]", textColor: "text-white" },
            category: "Vegetables",
            name: "Potatos 1kg",
            image: potato,
            rating: 4,
        ...
        {
            id: 3,
            badge: { text: "40% OFF", color: "bg-[#3B745B]", textColor: "text-white" },
            category: "Fruits",
            name: "Tomatos 200g",
            image: tomato,
            rating: 4,
        ...
        {
            id: 4,
            badge: { text: "25% OFF", color: "bg-[#FDC040]", textColor: "text-[#253D4E]" },
            category: "Vegetables",
            name: "Broccoli 1kg",
            image: broccoli,
            rating: 4,
        ...
        {
            id: 5,
            badge: { text: "35% OFF", color: "bg-[#3B745B]", textColor: "text-white" },
            category: "Vegetables",
        ...
        {
            id: 6,
            badge: { text: "20% OFF", color: "bg-[#FDC040]", textColor: "text-[#253D4E]" },
        ...
        {
            id: 7,
            badge: { text: "45% OFF", color: "bg-[#E74C3C]", textColor: "text-white" },
            category: "Coffee & Teas",
            name: "Green Tea 250g",
            image: greentea,
            rating: 4,
        ...
        {
            id: 8,
            badge: { text: "60% OFF", color: "bg-[#E74C3C]", textColor: "text-white" },
            category: "Meat",
        ...
        {
            id: 9,
            badge: { text: "55% OFF", color: "bg-[#E74C3C]", textColor: "text-white" },
            category: "Vegetables",
            name: "Onion 1kg",
            image: onion,
            rating: 4,
    ...
    const filteredProducts = selectedCategory === "All" 
        ? promotionProducts 
        : promotionProducts.filter(p => p.category === selectedCategory);
            ...
            <div className="mx-auto w-full max-w-[1600px] px-2 sm:px-4 md:px-6 lg:px-8">
                ...
                <div className="mb-6 sm:mb-8">
                    <nav className="flex items-center gap-2 text-xs sm:text-sm text-[#7E7E7E]">
                        ...
                        <span>/</span>
                        <span className="text-[#253D4E] font-semibold">Promotions</span>
                    </nav>
                </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#DEF9EC] flex items-center justify-center">
                                <Percent className="h-6 w-6 sm:h-7 sm:w-7 text-[#3B745B]" />
                            </div>
                            <div>
                                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#253D4E]">Promotions</h1>
                                <p className="text-sm sm:text-base text-[#7E7E7E]">Special offers and discount codes available now!</p>
                            </div>
                        </div>
                    </div>

                    {/* Promo Banner */}
                    <div className="mb-6 p-4 sm:p-6 bg-gradient-to-r from-[#3B745B] to-[#2a5542] rounded-xl sm:rounded-2xl text-white">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div>
                                <h2 className="text-xl sm:text-2xl font-bold mb-2">🎉 Special Promotion!</h2>
                                <p className="text-sm sm:text-base opacity-90">Use code <span className="font-bold">SAVE20</span> at checkout for an additional 20% off on all items</p>
                            </div>
                            <button className="px-4 sm:px-6 py-2 sm:py-3 bg-white text-[#3B745B] font-bold rounded-lg hover:bg-gray-100 transition-colors whitespace-nowrap text-sm sm:text-base">
                                Copy Code
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                        {filteredProducts.map((product) => (
                            ...
                            >
                                ...
                                {/* Promo Code Badge */}
                                <div className="absolute right-0 top-0 rounded-bl-xl sm:rounded-bl-2xl rounded-tr-xl sm:rounded-tr-2xl bg-[#3B745B] px-2 sm:px-3 py-1 sm:py-1.5 flex items-center gap-1 z-10">
                                    <Tag className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
                                    <span className="text-[10px] sm:text-xs font-bold text-white">{product.promoCode}</span>
                                </div>
                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col">
                                    ...
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <div className="flex items-center gap-1 rounded-lg bg-[#3B745B] px-2 sm:px-3 py-1">
                                            <Tag className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
                                            <span className="text-xs font-bold text-white">{product.promoCode}</span>
                                        </div>
                                    </div>
                ...
                {filteredProducts.length === 0 && (
                    <div className="text-center py-12 sm:py-16">
                        <Percent className="h-16 w-16 sm:h-20 sm:w-20 text-gray-300 mx-auto mb-4" />
                        <h3 className="text-xl sm:text-2xl font-bold text-[#253D4E] mb-2">No promotions found</h3>
